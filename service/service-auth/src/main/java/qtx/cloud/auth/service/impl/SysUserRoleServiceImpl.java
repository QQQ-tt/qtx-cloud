...
public class SysUserRoleServiceImpl extends ServiceImpl<SysUserRoleMapper, SysUserRole> implements SysUserRoleService {
    ...
    public void addRoleWithUser(UserRolesDTO dto) {
        remove(Wrappers.lambdaUpdate(SysUserRole.class).eq(SysUserRole::getUserCard, dto.getUserCode()));
        List<SysUserRole> list = new ArrayList<>();
        dto.getRoleIds().forEach(e -> list.add(SysUserRole.builder().userCard(dto.getUserCode()).roleId(e).build()));
