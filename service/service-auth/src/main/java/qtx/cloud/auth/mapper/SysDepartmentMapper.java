...
public interface SysDepartmentMapper extends BaseMapper<SysDepartment> {
     ...
     * @return 分页集合
     */
    IPage<DepartmentVO> selectPageNew(IPage<Object> page,
     ...
     * @return 集合
     */
    List<DepartmentListVO> selectNew(@Param(Constants.WRAPPER) LambdaQueryWrapper<SysDepartment> queryWrapper);
}
