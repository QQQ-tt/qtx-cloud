...
public class OssController {
  ...
  public Result<Boolean> uploadByBucket(
    ...
    return Result.success(
        service.uploadByBucket(file, otherInfo, bucket, business, version, fileUuid));
  }
  ...
  public void downloadBatch(HttpServletResponse response, @RequestBody List<OssBatchDTO> fileObject)
      throws IOException {
  ...
  public void downloadFileByBucket(
      @RequestParam String bucket, @RequestParam String fileObject, HttpServletResponse response)
      throws IOException {
  ...
  public Result<Boolean> removeFileByBucket(
      @RequestParam String fileObject, @RequestParam String bucket) {
