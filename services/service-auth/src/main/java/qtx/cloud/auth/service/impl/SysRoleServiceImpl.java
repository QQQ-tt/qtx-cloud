...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements SysRoleService {
    ...
    public boolean saveOrUpdateNew(SysRole entity) {
        SysRole one = getOne(Wrappers.lambdaQuery(SysRole.class)
                .eq(StringUtils.isNotBlank(entity.getRoleName()), SysRole::getRoleName, entity.getRoleName())
    ...
    public boolean updateSuper(Integer id, boolean flag) {
        return update(Wrappers.lambdaUpdate(SysRole.class).set(SysRole::getSuperUser, flag).eq(SysRole::getId, id));
    }
    ...
    public List<RoleListVO> listRole(RoleDTO dto) {
        return baseMapper.selectNew(Wrappers.lambdaQuery(SysRole.class)
                .likeRight(StringUtils.isNotBlank(dto.getName()), SysRole::getRoleName, dto.getName()));
    }
