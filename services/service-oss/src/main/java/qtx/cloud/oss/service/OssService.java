...
public interface OssService {
     ...
     * @param response 返回流
     */
    void downloadFileByBucket(String bucket, String fileObject, HttpServletResponse response) throws IOException;
     ...
     * @param fileObject 文件对象
     */
    void downloadFileBatch(HttpServletResponse response, List<OssBatchDTO> fileObject) throws IOException;
